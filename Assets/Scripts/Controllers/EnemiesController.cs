...
namespace Controllers
{
    ...
    {
        [SerializeField] private List<EnemyDto> AllEnemies;
        [SerializeField] private List<SpawnPoint> SpawnPoints;
        [SerializeField] private SoulEnemy EnemyPrefab;
        ...
        private void EnemyKilled(IEnemy enemy, KillInformation _)
        {
        ...
        private void SpawnEnemy()
        {
            ...
            SoulEnemy enemy = Instantiate(EnemyPrefab, SpawnPoints[freeSpawnPointIndex].Position.position, Quaternion.identity, transform);
